...
- Frequently, we'd like to make our navigation bar (navbar) visible so that we don't have to scroll all the way to the top to see the information. We can do this by using `fixed`.
